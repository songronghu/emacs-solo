...
*** Emacs Solo also have extra mini-packages built-in

Use =C-c d= or =M-x container-menu RET= to open a podman / docker
container manager.

   [[file:doc/demo-12-container-management.png]]


Use =C-c G= or =M-x gh-menu RET= to open a =gh= (github cli) UI:
